...
{
    "my_plans": ["A list of my plans for the day which the user might've affected."],
...
class Conversation:
    def __init__(self, character, phase):
        ...
        f"""
            ...
            Your day plan is to go to these places: {", ".join(character.get_plans())}
            You are at the index {phase} in that list.
